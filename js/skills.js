...
var skills = {
    ...
    'attackSong': genericAction('song', {'icon': bardIcon, 'tags': ['song', 'field'], 'target': 'none',
                                            'color': 'red', 'alpha': .2,
    ...
    'defenseSong': genericAction('song', {'icon': bardIcon, 'tags': ['song', 'field'], 'target': 'none',
                                            'color': 'blue', 'alpha': .2,
                                            sound: 'sounds/bfxr/strum.wav'},
    ...
    'heroSong': genericAction('heroSong', {'icon': bardIcon, 'tags': ['song', 'field'], 'target': 'none',
                                            'color': 'gold', 'alpha': .2,
                                            sound: 'sounds/bfxr/strum.wav'},
