...
//Rings
addItem(1, {'slot': 'ring', 'type': 'ring', 'name': 'Iron Band', 'bonuses': {'+minWeaponPhysicalDamage': 2, '+maxWeaponPhysicalDamage': 4}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(2, {'slot': 'ring', 'type': 'ring', 'name': 'Gold Band', 'bonuses': {'+minWeaponMagicDamage': 1, '+maxWeaponMagicDamage': 2}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(4, {'slot': 'ring', 'type': 'ring', 'name': 'Ruby Ring', 'bonuses': {'+strength': 6}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(5, {'slot': 'ring', 'type': 'ring', 'name': 'Emerald Ring', 'bonuses': {'+dexterity': 6}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(6, {'slot': 'ring', 'type': 'ring', 'name': 'Sapphire Ring', 'bonuses': {'+intelligence': 6}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(10, {'slot': 'ring', 'type': 'ring', 'name': 'Etched Band', 'bonuses': {'+magicBlock': 10}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(12, {'slot': 'ring', 'type': 'ring', 'name': 'Topaz Ring', 'bonuses': {'+strength': 3, '+dexterity': 3}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(13, {'slot': 'ring', 'type': 'ring', 'name': 'Aquamarine Ring', 'bonuses': {'+intelligence': 3, '+dexterity': 3}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(14, {'slot': 'ring', 'type': 'ring', 'name': 'Amethyst Ring', 'bonuses': {'+strength': 3, '+intelligence': 3}, 'source': equipmentSources.bracelet, icon: 'ring'});
addItem(19, {'slot': 'ring', 'type': 'ring', 'name': 'Diamond Ring', 'bonuses': {'+strength': 2, '+dexterity': 2, '+intelligence': 2}, 'source': equipmentSources.bracelet, icon: 'ring'});
