...
addItem(20, {'slot': 'back', 'type': 'amulet', 'name': 'Runed Amulet', 'bonuses': {'+wand:minMagicDamage': 1, '+wand:maxMagicDamage': 2, '+staff:minMagicDamage': 2, '+staff:maxMagicDamage': 3}, icon: 'backpack'});
...
addItem(6, {'slot': 'ring', 'type': 'ring', 'name': 'Sapphire Ring', 'bonuses': {'+intelligence': 6}, icon: 'accessory'});
addItem(10, {'slot': 'ring', 'type': 'ring', 'name': 'Adamantium Band', 'bonuses': {'+magicBlock': 10}, icon: 'accessory'});
addItem(12, {'slot': 'ring', 'type': 'ring', 'name': 'Topaz Ring', 'bonuses': {'+strength': 3, '+dexterity': 3}, icon: 'accessory'});
addItem(13, {'slot': 'ring', 'type': 'ring', 'name': 'Aquamarine Ring', 'bonuses': {'+intelligence': 3, '+dexterity': 3}, icon: 'accessory'});
addItem(14, {'slot': 'ring', 'type': 'ring', 'name': 'Amethyst Ring', 'bonuses': {'+strength': 3, '+intelligence': 3}, icon: 'accessory'});
addItem(19, {'slot': 'ring', 'type': 'ring', 'name': 'Diamond Ring', 'bonuses': {'+strength': 2, '+dexterity': 2, '+intelligence': 2}, icon: 'accessory'});
addItem(20, {'slot': 'ring', 'type': 'ring', 'name': 'Orchalcum Band', 'bonuses': {'+healthRegen': 4}, icon: 'accessory'});