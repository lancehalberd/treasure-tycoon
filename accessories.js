...
addItem(22, {'slot': 'ring', 'type': 'band', 'name': 'Meteoric Band', 'bonuses': {'%physicalDamage': 0.2}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(23, {'slot': 'ring', 'type': 'band', 'name': 'Orichalcum Band', 'bonuses': {'%magicDamage': 0.2}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(24, {'slot': 'ring', 'type': 'band', 'name': 'Adamantium Band', 'bonuses': {'%melee:damage': 0.2}, 'source': equipmentSources.bracelet, icon: 'band'});
addItem(25, {'slot': 'ring', 'type': 'band', 'name': 'Dragonbone Band', 'bonuses': {'%ranged:damage': 0.2}, 'source': equipmentSources.bracelet, icon: 'band'});
