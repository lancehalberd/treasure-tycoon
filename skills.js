...
var skills = {
    ...
    'hook':  attackAction('attack', {}, {'+cooldown': 10, '+range': 10, '+dragDamage': 0, '+dragStun': 0, '+knockbackRotation': -60, '+rangeDamage': 0, '$alwaysHits': 'Never misses', '$pullsTarget': 'Pulls target'},
    ...
    // Generic actions:
    'deflect': genericAction('deflect', {}, {'+damageRatio': [.5, '+', ['{strength}', '/', 100]], '+cooldown': ['20', '*', [100, '/', [100, '+', '{dexterity}']]], '+chance': 1},
    ...
    'stopTime': spellAction('stop', {'icon': 'gfx/496RpgIcons/clock.png', }, {'+duration': [1, '+', ['{intelligence}' , '/', '100']], '+cooldown': 120},
