var abilities = {
    ...
    'blackbelt': {'name': 'Martial Arts', 'bonuses': {'*fist:damage': 2, '*unarmed:damage': 2, '*unarmed:attackSpeed': 2, '+unarmed:critChance': .15, '*unarmed:critDamage': 2, '*unarmed:critAccuracy': 2}},
