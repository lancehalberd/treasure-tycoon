...
'passiveBonus': {'name': '-----Core Passives-----'},
    ...
    'minorVigor': {'name': 'Minor Vigor', 'bonuses': {'+dexterity': [5, '+', ['{level}', '/', 2]], '+strength': [5, '+', ['{level}', '/', 2]]}},
    ...
    'minorWill': {'name': 'Minor Will', 'bonuses': {'+strength': [5, '+', ['{level}', '/', 2]], '+intelligence': [5, '+', ['{level}', '/', 2]]}},
    ...
    'minorCharisma': {'name': 'Minor Charisma', 'bonuses': {'+dexterity': [5, '+', ['{level}', '/', 2]], '+intelligence': [5, '+', ['{level}', '/', 2]]}},
...
'specializationIndex': {'name': '-----Specialization-----'},
    'throwingPower': {'name': 'Throwing Power', 'icon': 'gfx/496RpgIcons/buffThrown.png', 'bonuses': {'%throwing:physicalDamage': .3, '+throwing:weaponRange': 2}},
    'throwingDamage': {'name': 'Throwing Mastery', 'icon': 'gfx/496RpgIcons/buffThrown.png', 'bonuses': {'%throwing:physicalDamage': .2, '%throwing:attackSpeed': .2}},
    ...
    'throwingParadigmShift': {'name': 'Melee Throwing', 'icon': 'gfx/496RpgIcons/buffThrown.png', 'bonuses': {'$throwing:setRange': 'melee', '$throwing:weaponRange': 1, '*throwing:damage': 1.3, '*throwing:attackSpeed': 1.3}},
    'rangedAccuracy': {'name': 'Ranged Accuracy', 'icon': 'gfx/496RpgIcons/target.png', 'bonuses': {'%ranged:accuracy': .3, '+ranged:range': 1}},
    'rangedDamage': {'name': 'Ranged Damage', 'icon': 'gfx/496RpgIcons/target.png', 'bonuses': {'%ranged:damage': .2, '+ranged:range': 1}},
    'rangedAttackSpeed': {'name': 'Ranged Attack Speed', 'icon': 'gfx/496RpgIcons/target.png', 'bonuses': {'%ranged:attackSpeed': .2, '+ranged:range': 1}},
    'rangedParadigmShift': {'name': 'Close Quarters', 'icon': 'gfx/496RpgIcons/target.png', 'bonuses': {'*ranged:range': .5, '*ranged:damage': 1.3, '*ranged:accuracy': 1.3}},
    'bowRange': {'name': 'Bow Range', 'icon': 'gfx/496RpgIcons/buffBow.png', 'bonuses': {'+bow:weaponRange': 3, '+bow:critDamage': .5}},
    'bowPhysicalDamage': {'name': 'Physical Bow Damage', 'icon': 'gfx/496RpgIcons/buffBow.png', 'bonuses': {'%bow:physicalDamage': 0.3, '+bow:critDamage': 0.3}},
    'bowDamage': {'name': 'Bow Damage', 'icon': 'gfx/496RpgIcons/buffBow.png', 'bonuses': {'%bow:damage': 0.3, '+bow:critDamage': .3}},
    ...
    'fistDamage': {'name': 'Fist Damage', 'icon': 'gfx/496RpgIcons/buffFist.png', 'bonuses': {'%fist:physicalDamage': .3, '+fist:critDamage': .3}},
    'fistCriticalChance': {'name': 'Fist Precision', 'icon': 'gfx/496RpgIcons/buffFist.png', 'bonuses': {'%fist:critChance': .3, '%fist:accuracy': .3}},
    'fistAttackSpeed': {'name': 'Fist Attack Speed', 'icon': 'gfx/496RpgIcons/buffFist.png', 'bonuses': {'%fist:attackSpeed': .2, '%fist:physicalDamage': .2}},
    //'fistParadigmShift': {'name': '', 'icon': 'gfx/496RpgIcons/buffFist.png', 'bonuses': {}},
    'swordPhysicalDamage': {'name': 'Sword Damage', 'icon': 'gfx/496RpgIcons/buffSword.png', 'bonuses': {'%sword:physicalDamage': .3, '%sword:critChance': .3}},
    'swordAccuracy': {'name': 'Sword Accuracy', 'icon': 'gfx/496RpgIcons/buffSword.png', 'bonuses': {'%sword:accuracy': .5, '+sword:critChance': .2}},
    'swordAttackSpeed': {'name': 'Sword Attack Speed', 'icon': 'gfx/496RpgIcons/buffSword.png', 'bonuses': {'%sword:attackSpeed': .2, '%sword:physicalDamage': .2}},
    'swordParadigmShift': {'name': 'Two Hands', 'icon': 'gfx/496RpgIcons/buffSword.png', 'bonuses': {'*noOffhand:sword:damage': 1.5, '*noOffhand:sword:attackSpeed': .75}},
    'greatswordDamage': {'name': 'Greatsword Damage', 'icon': 'gfx/496RpgIcons/buffGreatSword.png', 'bonuses': {'%greatsword:damage': .3, '%greatsword:critChance': .3}},
    'greatswordPhysicalDamage': {'name': 'Greatsword Physical Damage', 'icon': 'gfx/496RpgIcons/buffGreatSword.png', 'bonuses': {'%greatsword:physicalDamage': .4, '%greatsword:accuracy': .2}},
    'greatswordAccuracy': {'name': 'Greatsword Accuracy', 'icon': 'gfx/496RpgIcons/buffGreatSword.png', 'bonuses': {'%greatsword:accuracy': .5, '%greatsword:physicalDamage': 0.2}},
    ...
    'staffAccuracy': {'name': 'Staff Accuracy', 'icon': 'gfx/496RpgIcons/buffStaff.png', 'bonuses': {'%staff:accuracy': .3, '%staff:damage': .3}},
    //'staffParadigmShift': {'name': '', 'icon': 'gfx/496RpgIcons/buffStaff.png', 'bonuses': {'%:': .3, '%:': .3}},
    ...
    'axePhysicalDamage': {'name': 'Axe Physical Damage', 'icon': 'gfx/496RpgIcons/buffAxe.png', 'bonuses': {'%axe:physicalDamage': .4, '%axe:accuracy': .2}},
    'axeAttackSpeed': {'name': 'Axe Attack Speed', 'icon': 'gfx/496RpgIcons/buffAxe.png', 'bonuses': {'%axe:attackSpeed': .4, '%axe:accuracy': .2}},
    'axeCritDamage': {'name': 'Axe Critical Damage', 'icon': 'gfx/496RpgIcons/buffAxe.png', 'bonuses': {'+axe:critDamage': .3, '%axe:physicalDamage': .3}},
    ...
    'polearmRange': {'name': 'Polearm Range', 'icon': 'gfx/496RpgIcons/buffPolearm.png', 'bonuses': {'+polearm:weaponRange': 1, '%polearm:physicalDamage': .4}},
    'polearmAccuracy': {'name': 'Polearm Accuracy', 'icon': 'gfx/496RpgIcons/buffPolearm.png', 'bonuses': {'%polearm:accuracy': .3, '%polearm:damage': .3}},
    'polearmCritDamage': {'name': 'Polearm Critical Damage', 'icon': 'gfx/496RpgIcons/buffPolearm.png', 'bonuses': {'+polearm:critDamage': .3, '%polearm:physicalDamage': .3}},
    //'polearmParadigmShift': {'name': '', 'icon': 'gfx/496RpgIcons/buffPolearm.png', 'bonuses': {'%:': .3, '%:': .3}},
    ...
    'daggerCritChance': {'name': 'Dagger Critical Chance', 'icon': 'gfx/496RpgIcons/buffDagger.png', 'bonuses': {'%dagger:critChance': .3, '%dagger:damage': .2}},
    'daggerDamage': {'name': 'Dagger Damage', 'icon': 'gfx/496RpgIcons/buffDagger.png', 'bonuses': {'%dagger:damage': .2, '%dagger:attackSpeed': .2}},
