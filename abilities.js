...
'tier2Index': {'name': '------Tier 2------'},
    'corsairIndex': {'name': '---Corsair---'},
        'corsair': {'name': 'Venom', 'bonuses': {'+poison': .2}, 'onHitEffect': {'variableObjectType': 'trigger', 'debuff': debuffEffect({}, {'*damage': .9})},
    ...
    'dancerIndex': {'name': '---Dancer---'},
        ...
        'dervish': {'name': 'Whirling Dervish', 'bonuses': {'+dexterity': 15}, 'onHitEffect': {'variableObjectType': 'trigger', 'buff': buffEffect({}, {'%attackSpeed': .05, '%speed': .05, 'duration': 2, 'area': 0})},
...
'tier4Index': {'name': '------Tier 4------'},
    'assassinIndex': {'name': '---Assassin---'},
        ...
        'cripple': {'name': 'Cripple', 'bonuses': {'+strength': 10, '+dexterity': 10},
                'onCritEffect': {'variableObjectType': 'trigger', 'debuff': debuffEffect({}, {'*speed': .5, '*attackSpeed': .5, '+duration': 5})}},
