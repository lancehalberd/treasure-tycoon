...
'tier4Index': {'name': '------Tier 4------'},
    'assassinIndex': {'name': '---Assassin---'},
        ...
        'cull': {'name': 'Cull', 'bonuses': {'+strength': 10, '+cull': .1}, 'icon': jobIcon(3, 1)},
        'cripple': {'name': 'Cripple', 'bonuses': {'+strength': 10, '+dexterity': 10}, 'icon': jobIcon(3, 1),
    ...
    'darkknightIndex': {'name': '---Dark Knight---'},
        ...
        'reaper': {'name': 'Reaper', 'bonuses': {'+intelligence': 10, '+strength': 5, '+consume:count': 1, '+consume:duration': 10}, 'icon': jobIcon(3, 2),
