...
//Back/Neck/Waist
addItem(1, {'slot': 'back', 'type': 'quiver', 'name': 'Quiver', 'bonuses': {'+bow:minDamage': 2, '+bow:maxDamage': 4}, icon: 'bag'});
...
//Rings
addItem(1, {'slot': 'ring', 'type': 'ring', 'name': 'Iron Band', 'bonuses': {'+minDamage': 2, '+maxDamage': 4}, icon: 'bag'});
addItem(2, {'slot': 'ring', 'type': 'ring', 'name': 'Gold Band', 'bonuses': {'+minMagicDamage': 1, '+maxMagicDamage': 2}, icon: 'bag'});
addItem(4, {'slot': 'ring', 'type': 'ring', 'name': 'Ruby Ring', 'bonuses': {'+strength': 6}, icon: 'bag'});
addItem(5, {'slot': 'ring', 'type': 'ring', 'name': 'Emerald Ring', 'bonuses': {'+dexterity': 6}, icon: 'bag'});
addItem(6, {'slot': 'ring', 'type': 'ring', 'name': 'Sapphire Ring', 'bonuses': {'+intelligence': 6}, icon: 'bag'});
addItem(10, {'slot': 'ring', 'type': 'ring', 'name': 'Adamantium Band', 'bonuses': {'+magicBlock': 10}, icon: 'bag'});
addItem(12, {'slot': 'ring', 'type': 'ring', 'name': 'Topaz Ring', 'bonuses': {'+strength': 3, '+dexterity': 3}, icon: 'bag'});
addItem(13, {'slot': 'ring', 'type': 'ring', 'name': 'Aquamarine Ring', 'bonuses': {'+intelligence': 3, '+dexterity': 3}, icon: 'bag'});
addItem(14, {'slot': 'ring', 'type': 'ring', 'name': 'Amethyst Ring', 'bonuses': {'+strength': 3, '+intelligence': 3}, icon: 'bag'});
addItem(19, {'slot': 'ring', 'type': 'ring', 'name': 'Diamond Ring', 'bonuses': {'+strength': 2, '+dexterity': 2, '+intelligence': 2}, icon: 'bag'});
addItem(20, {'slot': 'ring', 'type': 'ring', 'name': 'Orchalcum Band', 'bonuses': {'+healthRegen': 4}, icon: 'bag'});
