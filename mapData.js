var map = {
    ...
    'priest2': {
        ...
        'coords': [-274,84,-527],
        'background': "field",
        'unlocks': ["bayou","cemetery","priest3"],
        'specialLoot': [],
        'skill': null,
        'board': null,
        'enemySkills': [],
    ...
    'temple': {
        ...
        'coords': [1,212,-561],
        'background': "cave",
        'unlocks': ["trail","traininggrounds","barracks","meadow"],
        'specialLoot': ["simpleSaphireLoot"],
        'skill': "protect",
        'board': "halfHexBoard",
        'enemySkills': ["heal"],
