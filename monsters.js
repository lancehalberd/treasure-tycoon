...
function initalizeMonsters() {
    ...
    var butterflySource = setupActorSource({'image': enemySheet('gfx/yellowButterfly.png'), 'width': 64, 'actualWidth': 48, 'height': 64,
    ...
    var monarchSource = setupActorSource({'image': enemySheet('gfx/monarchButterfly.png'), 'width': 64, 'actualWidth': 48, 'height': 64,
            framesPerRow: 7, walkFrames: [1, 2, 3, 4, 5, 6, 4, 2, 0], attackFrames: [7, 10, 11, 10], deathFrames: [7, 8, 9, 9]});
    addMonster('dummy', {
